        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">OPTIMASI PENGADAAN</h4>
                </div>
            </div>
        </div>
        <!-- end row -->
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="m-b-30 m-t-0 header-title">OPTIMASI PENGADAAN</h4>
                                <hr>
                                <form>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            ...
                            while ($rp = mysql_fetch_array($tampil)) {
                                ...
                                $penjualan = $data_penjualan[$no - 1];
                                $stok_akhir = $data_stok_akhir[$no - 1];
                                ...
                                $z[3] = $pengadaan_min + ( $x[3] * ($pengadaan_max - $pengadaan_min));
                                ...
                                $z[4] = $pengadaan_min + ( $x[4] * ($pengadaan_max - $pengadaan_min));
...
//                        var_dump($z[3]);die;
                                ...
                                <tr>
                                    ...
                                    <td><?= $rp[nama_tipe] ?></td>
                                    <td><?= ceil($hasil) ?> Items</td>
                                    <td>
                                        <a type="button" href='?module=optimasi_pengadaan&act=detail&id_brand=<?= $id_brand ?>&id_tipe=<?= $rp[id_tipe] ?>' target="_blank" class="btn waves-effect waves-light btn-success"><i class="fa fa-info"></i></a>
                                    </td>
...
//
                    ...
                    <div class="row m-t-50">
                        ...
                        <div class="col-sm-4 m-t-20">
                            ...
                            <ul>
                                ...
                                <li>
                                    R[2] IF Penjualan Turun AND Stok Sedikit THEN Pengadaan Barang Berkurang
                                    <ul>
                                        <li>
                                            predikat 2 = <?= $x[2] ?>
                                        </li>
                                ...
                                <li>
                                    R[3] IF Penjualan Naik AND Stok Banyak THEN Pengadaan Barang Bertambah
                                    <ul>
                                        <li>
                                            predikat 3 = <?= $x[3] ?>
                                        </li>
                                ...
                                <li>
                                    R[4] IF Penjualan Naik AND Stok Sedikit THEN Pengadaan Barang Bertambah
                                    <ul>
                                        <li>
                                            predikat 4 = <?= $x[4] ?>
                                        </li>
                    ...
                    Hasil Perhitungan Nilai Optimal Untuk Pengadaan Periode Berikutnya Adalah <b><?= ceil($hasil_akhir) ?></b>
